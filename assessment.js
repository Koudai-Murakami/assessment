...
anchor.innerText = 'Tweet #あなたのいいところ';　//ボタン表示内容
tweetDivided.appendChild(anchor);　//aタグをツイートエリアに表示

const script = document.createElement('script'); //scriptタグを新しく作る
script.setAttribute('src', 'https://platform.twitter.com/widgets.js'); //読み込むjsファイル（twitterが提供しているwidegets.jsファイルを読み込む）
tweetDivided.appendChild(script); //scriptタグをHTML条(ツイートエリアに)設置
}
